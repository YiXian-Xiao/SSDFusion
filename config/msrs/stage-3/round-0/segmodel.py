...
data_preprocessor = dict(
    ...
    std=[58.32, 58.68, 59.42],
    test_cfg=dict(size_divisor=32),
    type='SegDataPreProcessor')
data_root = '/data/xiaoyixian/MMSFusion/work/MSCAN-26-META-0/output'
...
img_norm_cfg = dict(
    mean=[57.96, 66.32, 57.33], std=[58.32, 58.68, 59.42], to_rgb=True)
img_ratios = [
    0.5,
    0.75,
    1.0,
...
train_cfg = dict(
    max_iters=24000, type='IterBasedTrainLoop', val_interval=4000)
